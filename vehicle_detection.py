...
def vehicleDetect(loc, allCoor):
    ...
    #initiate the model based on network and device
    model_vehicle_detection = ie.load_network(net_vd,'CPU')

    #load the raw video input
    ...
    while (vid_raw.isOpened()):
        ...
        #making the 'vehicle detection' box
